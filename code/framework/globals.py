...
class Globals():
    ...
    def __init__(self):
        ...
        self.default_root_dir = '/content/drive/My Drive/gan_proj/framework/zhq/new_gan_exp/'
        self.default_feature_dir = self.default_root_dir + 'features/'
        self.default_repo_dir = self.default_root_dir + 'repo/'
        self.default_data_dir = '/content/drive/My Drive/gan_proj/framework/zhq/data/'
        self.default_model_dir = '/content/drive/My Drive/gan_proj/framework/zhq/models/'
...
def addDataInfo(opt):
    if opt.data == 'mnist':
        ...
        opt.sampleSize = 20000
        opt.dataset = 'celeba'
        opt.dataroot = 'D:\celeba2'
        #g.default_data_dir + 'celeba'

    elif opt.data == 'cifar10':
        opt.sampleSize = 16200
        opt.dataset = 'cifar10'
        opt.dataroot = g.default_data_dir + 'cifar10'
...
def getDataSet(opt, needShuf=True):
    if opt.dataset in ['imagenet', 'folder', 'lfw', 'celeba']:
        # folder dataset
        dataset = dset.ImageFolder(root='D:\celeba2',transform=transforms.Compose([
